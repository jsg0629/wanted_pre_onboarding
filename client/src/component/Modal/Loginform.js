    ...
    <div>
      <form action="" method="POST">
        <div className="input-box">
          ...
          {isEmailCheck ?  <i className="fa-solid fa-circle-check" /> : <i className="fa-solid fa-circle-exclamation" onClick={() => {
               if (blank_pattern.test(email)) {
                // 공백검사
                setEmail('')
        ...
        <div className="input-box">
          ...
          {showPassword ? <i className="fa-solid fa-eye" onClick={togglePass} /> : <i className="fa-solid fa-eye-slash" onClick={togglePass} />}
        </div>
